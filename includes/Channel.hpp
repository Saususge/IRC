...
class Channel : private IChannel {
 public:
  ...
  IRC::Numeric broadcast(const std::string& msg,
                                 const std::string& except = "");

  IRC::Numeric addClient(const std::string& nick);
  ...
  IRC::Numeric setMode(const std::string& requesterNick,
                               IChannelMode mode);
  IRC::Numeric addMode(const std::string& requesterNick,
                               IChannelMode mode);
  IRC::Numeric removeMode(const std::string& requesterNick,
                                  IChannelMode mode);
